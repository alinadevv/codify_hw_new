products = (
    {"id": 1, "name": "Молоко", "price": 65},
    {"id": 2, "name": "Творог", "price": 90},
    {"id": 3, "name": "Говядина", "price": 280},
    {"id": 4, "name": "Курица", "price": 125},
    {"id": 5, "name": "Кефир", "price": 54}
)
...
def options():
    print(divider1)
    print('''Добро пожаловать в раздел "Мясо и молочная продукция"!
