products = ({'id': 1, 'name': 'Арбуз', 'price': 60},
            {'id': 2, 'name': 'Дыня', 'price': 20},
            {'id': 3, 'name': 'Цукини', 'price': 10},
            {'id': 4, 'name': 'Капуста', 'price': 24},
            {'id': 5, 'name': 'Авокадо', 'price': 180}
            )
...
def options():
    print(divider1)
    print('''Добро пожаловать в раздел "Овощи и фрукты"!
